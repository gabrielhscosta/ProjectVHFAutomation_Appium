...
namespace VHFAutomation.TestCase
{
    ...
    public class CN001LoginVHF : SessaoMain
    {
        ...
        public void ValidaLoginVHF()
        {
            ...
            Elementos.EncontraElementosClassName(acessarModulo, appObjectsVhf.caixaTexto).ElementAt(0).SendKeys(appObjectsVhf.userSys);
            Elementos.EncontraElementosClassName(acessarModulo, appObjectsVhf.caixaTexto).ElementAt(1).SendKeys(appObjectsVhf.passSys);
